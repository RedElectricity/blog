...
"当然, 这里也会有领域, 也需要一定的能力才能打开", 五条说着, "但是, 有我一半六眼的悠仁也是能打开的"
...
"也不是, 我做了一些眼镜使得未获得咒力者能看到这一切. 但是若要长久地看到向量世界还是需要一些特殊的修行", 五条说着, "其实六眼的另外一种作用是能够看到物体矩阵的更详细参数"

虎杖摸了摸下巴, 再次问道: "那么是不是每次操控物体都要计算器?"

五条露出了微笑: "只要你够熟练, 其实不需要计算器也能操控."

"对了, 其实这个向量世界其实也是危险丛生的, 但是我还没过多地探索.", 五条说着, "所以需要使野蔷薇和惠他们也能看见向量世界才行"
...
"因为他不需要眼镜也能看见, 现在你们戴上它", 当两个人都带上眼镜之后, 五条悟便念出了咒语
...
"现在大体的情况是这样的, 不只我们可以进入到'向量世界', 而且现在官方也在探索这个'向量世界'", 五条悟解释着当前的境地, "所以你们想要一起加入**夜行者**吗"

惠开口回答道: "悠仁这么说呢, 要是悠仁加入了我们两个也加入到其中"
...
"不过你们先拿着这个, 我该装过的计算器", 说着, 五条悟便给了野蔷薇和惠一人一台 `HP Prime`
...
五条笑了下: "这个嘛, 只需要在被加矩阵乘个$-1$的标量不久好了吗"
